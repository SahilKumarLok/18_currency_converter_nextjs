            ...
            <div className="grid grid-cols-[1fr_auto] items-center gap-2">
              ...
              <div className="grid grid-cols-[1fr_auto] items-center gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: Currency) => handleSourceCurrencyChange(value)} // Corrected arrow function
                >
            ...
            <div className="grid grid-cols-[1fr_auto] items-center gap-2">
              ...
              <div className="grid grid-cols-[1fr_auto] items-center gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: Currency) => handleTargetCurrencyChange(value)} // Corrected arrow function
                >
                  <SelectTrigger className="w-24">
